...
Locker::Locker(int id, int lockerNumber, const string &location, Size size, float price, string status) : lockerNumber(
        lockerNumber),
                                                                                                          location(
                                                                                                                  location),
                                                                                                          size(size),
...
bool Locker::operator<(const Locker & l) const {
    return lockerNumber < l.lockerNumber;
}
